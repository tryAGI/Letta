...
namespace Letta
{
    public partial class FeedsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_FeedsBackfillSubscriptionSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
        ...
        partial void PrepareFeedsBackfillSubscriptionArguments(
            ...
            global::Letta.FeedsBackfillSubscriptionRequest request);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.FeedsBackfillSubscriptionResponse> FeedsBackfillSubscriptionAsync(
            string feedId,
            string subscriptionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.FeedsBackfillSubscriptionResponse>> FeedsBackfillSubscriptionAsResponseAsync(
            string feedId,
            string subscriptionId,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Letta.FeedsBackfillSubscriptionResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Letta.FeedsBackfillSubscriptionResponse2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.FeedsBackfillSubscriptionResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.FeedsBackfillSubscriptionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.FeedsBackfillSubscriptionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.FeedsBackfillSubscriptionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
