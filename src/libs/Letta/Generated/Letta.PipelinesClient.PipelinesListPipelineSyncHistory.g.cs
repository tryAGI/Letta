...
namespace Letta
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_PipelinesListPipelineSyncHistorySecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_PipelinesListPipelineSyncHistorySecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.PipelinesListPipelineSyncHistoryResponse> PipelinesListPipelineSyncHistoryAsync(
            string pipelineId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PipelinesListPipelineSyncHistoryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesListPipelineSyncHistoryResponse>> PipelinesListPipelineSyncHistoryAsResponseAsync(
            string pipelineId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinesListPipelineSyncHistorySecurityRequirements,
                operationName: "PipelinesListPipelineSyncHistoryAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinesListPipelineSyncHistory",
                                methodName: "PipelinesListPipelineSyncHistoryAsync",
                                pathTemplate: "$\"/v1/pipelines/{pipelineId}/sync/history\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Letta.PipelinesListPipelineSyncHistoryResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Letta.PipelinesListPipelineSyncHistoryResponse2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.PipelinesListPipelineSyncHistoryResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.PipelinesListPipelineSyncHistoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesListPipelineSyncHistoryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.PipelinesListPipelineSyncHistoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
