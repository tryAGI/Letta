...
namespace Letta
{
    ...
    public sealed partial class GroupSchema
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Letta.JsonConverters.ManagerConfig2JsonConverter))]
        public global::Letta.ManagerConfig2? ManagerConfig { get; set; }
        ...
        public GroupSchema(
            ...
            string description,
            string id,
            global::Letta.ManagerConfig2? managerConfig,
            string? projectId,
