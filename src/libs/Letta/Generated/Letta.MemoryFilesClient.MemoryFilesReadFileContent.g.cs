...
namespace Letta
{
    public partial class MemoryFilesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_MemoryFilesReadFileContentSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.MemoryFilesReadFileContentResponse> MemoryFilesReadFileContentAsync(
            string agentId,
            string filePath,
            string? @ref = default,
        ...
        {
            var __response = await MemoryFilesReadFileContentAsResponseAsync(
                agentId: agentId,
                filePath: filePath,
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.MemoryFilesReadFileContentResponse>> MemoryFilesReadFileContentAsResponseAsync(
            string agentId,
            string filePath,
            string? @ref = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MemoryFilesReadFileContent",
                                methodName: "MemoryFilesReadFileContentAsync",
                                pathTemplate: "$\"/v1/agents/{agentId}/memory-files/content\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Letta.MemoryFilesReadFileContentResponse2? __value_404 = null;
                                try
                                {
                                ...
                                throw global::Letta.ApiException<global::Letta.MemoryFilesReadFileContentResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                global::Letta.MemoryFilesReadFileContentResponse3? __value_501 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                ...
                                throw global::Letta.ApiException<global::Letta.MemoryFilesReadFileContentResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.MemoryFilesReadFileContentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.MemoryFilesReadFileContentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.MemoryFilesReadFileContentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
