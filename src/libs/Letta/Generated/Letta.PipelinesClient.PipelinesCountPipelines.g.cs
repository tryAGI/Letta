...
namespace Letta
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_PipelinesCountPipelinesSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_PipelinesCountPipelinesSecurityRequirement0,
            };
        partial void PreparePipelinesCountPipelinesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? search,
            ref string? integrationType,
            ref string? integrationId);
        partial void PreparePipelinesCountPipelinesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? search,
            string? integrationType,
            string? integrationId);
        partial void ProcessPipelinesCountPipelinesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelinesCountPipelinesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.PipelinesCountPipelinesResponse> PipelinesCountPipelinesAsync(
        ...
        {
            var __response = await PipelinesCountPipelinesAsResponseAsync(
                search: search,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesCountPipelinesResponse>> PipelinesCountPipelinesAsResponseAsync(
            string? search = default,
            string? integrationType = default,
            string? integrationId = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePipelinesCountPipelinesArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinesCountPipelinesSecurityRequirements,
                operationName: "PipelinesCountPipelinesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePipelinesCountPipelinesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinesCountPipelines",
                                methodName: "PipelinesCountPipelinesAsync",
                                pathTemplate: "\"/v1/pipelines/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelinesCountPipelinesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelinesCountPipelinesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.PipelinesCountPipelinesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesCountPipelinesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.PipelinesCountPipelinesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
