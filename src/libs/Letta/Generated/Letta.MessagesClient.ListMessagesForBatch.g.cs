...
namespace Letta
{
    public partial class MessagesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_ListMessagesForBatchSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
        ...
        partial void PrepareListMessagesForBatchArguments(
            ...
            ref string? after,
            int? limit,
            ref global::Letta.ListMessagesForBatchOrder? order,
            ref string? orderBy,
            ref string? agentId);
        partial void PrepareListMessagesForBatchRequest(
            ...
            string? after,
            int? limit,
            global::Letta.ListMessagesForBatchOrder? order,
            string? orderBy,
            string? agentId);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.LettaBatchMessages> ListMessagesForBatchAsync(
            string batchId,
        ...
        {
            var __response = await ListMessagesForBatchAsResponseAsync(
                batchId: batchId,
                before: before,
                after: after,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.LettaBatchMessages>> ListMessagesForBatchAsResponseAsync(
            string batchId,
            string? before = default,
            string? after = default,
            int? limit = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListMessagesForBatch",
                                methodName: "ListMessagesForBatchAsync",
                                pathTemplate: "$\"/v1/messages/batches/{batchId}/messages\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.LettaBatchMessages.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.LettaBatchMessages>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.LettaBatchMessages.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
