...
namespace Letta
{
    public partial interface IMemoryFilesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.MemoryFilesReadFileContentResponse>> MemoryFilesReadFileContentAsResponseAsync(
            string agentId,
            string filePath,
            string? @ref = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
