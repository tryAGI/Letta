...
namespace Letta
{
    public partial interface IFoldersClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Letta.FileMetadata> RetrieveFileAsync(
            string folderId,
            string fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.FileMetadata>> RetrieveFileAsResponseAsync(
            string folderId,
            string fileId,
            bool? includeContent = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
