...
namespace Letta
{
    public partial class BlocksClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_ListAgentsForBlockSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_ListAgentsForBlockSecurityRequirement0,
            };
        partial void PrepareListAgentsForBlockArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string blockId,
            ref string? before,
            ref string? after,
            int? limit,
            ref global::Letta.ListAgentsForBlockOrder? order,
            ref string? orderBy,
            global::System.Collections.Generic.IList<string>? includeRelationships,
            global::System.Collections.Generic.IList<global::Letta.ListAgentsForBlockIncludeItem>? include);
        partial void PrepareListAgentsForBlockRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? after,
            int? limit,
            global::Letta.ListAgentsForBlockOrder? order,
            string? orderBy,
            global::System.Collections.Generic.IList<string>? includeRelationships,
            global::System.Collections.Generic.IList<global::Letta.ListAgentsForBlockIncludeItem>? include);
        partial void ProcessListAgentsForBlockResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAgentsForBlockResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Letta.AgentState>> ListAgentsForBlockAsync(
            string blockId,
            string? before = default,
            string? after = default,
            int? limit = default,
            global::Letta.ListAgentsForBlockOrder? order = default,
        ...
        {
            var __response = await ListAgentsForBlockAsResponseAsync(
                blockId: blockId,
                before: before,
                after: after,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Letta.AgentState>>> ListAgentsForBlockAsResponseAsync(
            string blockId,
            string? before = default,
            string? after = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAgentsForBlockArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAgentsForBlockSecurityRequirements,
                operationName: "ListAgentsForBlockAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListAgentsForBlockRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListAgentsForBlock",
                                methodName: "ListAgentsForBlockAsync",
                                pathTemplate: "$\"/v1/blocks/{blockId}/agents\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAgentsForBlockResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAgentsForBlockResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
