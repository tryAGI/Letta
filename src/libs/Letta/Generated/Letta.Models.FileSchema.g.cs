...
namespace Letta
{
    ...
    public sealed partial class FileSchema
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Letta.JsonConverters.FileProcessingStatusJsonConverter))]
        public global::Letta.FileProcessingStatus? ProcessingStatus { get; set; }
        ...
        public FileSchema(
            ...
            global::Letta.FileProcessingStatus? processingStatus,
            string? errorMessage,
            int? totalChunks,
            int? chunksEmbedded,
            string? content)
