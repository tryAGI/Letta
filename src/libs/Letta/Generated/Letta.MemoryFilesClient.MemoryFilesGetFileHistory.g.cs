...
namespace Letta
{
    public partial class MemoryFilesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.MemoryFilesGetFileHistoryResponse>> MemoryFilesGetFileHistoryAsResponseAsync(
            string agentId,
            string filePath,
            double? limit = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::Letta.ApiException<global::Letta.MemoryFilesGetFileHistoryResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                throw global::Letta.ApiException<global::Letta.MemoryFilesGetFileHistoryResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.MemoryFilesGetFileHistoryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.MemoryFilesGetFileHistoryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.MemoryFilesGetFileHistoryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
