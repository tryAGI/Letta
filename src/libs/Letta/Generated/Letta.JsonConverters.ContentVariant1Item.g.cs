...
{
    /// <inheritdoc />
    public class ContentVariant1ItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Letta.ContentVariant1Item>
    {
        /// <inheritdoc />
        public override global::Letta.ContentVariant1Item Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Letta.MessageContentVariant1ItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Letta.MessageContentVariant1ItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Letta.MessageContentVariant1ItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Letta.TextContent? text = default;
            if (discriminator?.Type == global::Letta.MessageContentVariant1ItemDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::Letta.MessageContentVariant1ItemDiscriminatorType.Image)
            {
            ...
            if (discriminator?.Type == global::Letta.MessageContentVariant1ItemDiscriminatorType.ToolCall)
            {
            ...
            if (discriminator?.Type == global::Letta.MessageContentVariant1ItemDiscriminatorType.ToolReturn)
            {
            ...
            if (discriminator?.Type == global::Letta.MessageContentVariant1ItemDiscriminatorType.OmittedReasoning)
            {
            ...
            if (discriminator?.Type == global::Letta.MessageContentVariant1ItemDiscriminatorType.RedactedReasoning)
            {
            ...
            if (discriminator?.Type == global::Letta.MessageContentVariant1ItemDiscriminatorType.SummarizedReasoning)
            {
            ...
            var __value = new global::Letta.ContentVariant1Item(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::Letta.ContentVariant1Item value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
