...
namespace Letta
{
    public partial class DeviceStorageClient
    {
        ...
        {
            var __response = await DeviceStorageGetDeviceStorageKeyAsResponseAsync(
                deviceId: deviceId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.DeviceStorageGetDeviceStorageKeyResponse>> DeviceStorageGetDeviceStorageKeyAsResponseAsync(
            string deviceId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeviceStorageGetDeviceStorageKey",
                                methodName: "DeviceStorageGetDeviceStorageKeyAsync",
                                pathTemplate: "\"/v1/device-storage-key\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.DeviceStorageGetDeviceStorageKeyResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.DeviceStorageGetDeviceStorageKeyResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.DeviceStorageGetDeviceStorageKeyResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
