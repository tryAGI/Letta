...
namespace Letta
{
    public partial class FeedsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_FeedsDeleteFeedSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_FeedsDeleteFeedSecurityRequirement0,
            };
        partial void PrepareFeedsDeleteFeedArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string feedId,
            object request);
        partial void PrepareFeedsDeleteFeedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string feedId,
            object request);
        partial void ProcessFeedsDeleteFeedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFeedsDeleteFeedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.FeedsDeleteFeedResponse> FeedsDeleteFeedAsync(
            string feedId,
        ...
        {
            var __response = await FeedsDeleteFeedAsResponseAsync(
                feedId: feedId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.FeedsDeleteFeedResponse>> FeedsDeleteFeedAsResponseAsync(
            string feedId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareFeedsDeleteFeedArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FeedsDeleteFeedSecurityRequirements,
                operationName: "FeedsDeleteFeedAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FeedsDeleteFeed",
                                methodName: "FeedsDeleteFeedAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFeedsDeleteFeedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFeedsDeleteFeedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.FeedsDeleteFeedResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.FeedsDeleteFeedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.FeedsDeleteFeedResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await FeedsDeleteFeedAsync(
                feedId: feedId,
                request: __request,
                requestOptions: requestOptions,
