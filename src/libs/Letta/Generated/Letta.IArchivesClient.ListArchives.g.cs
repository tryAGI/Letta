...
namespace Letta
{
    public partial interface IArchivesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Letta.Archive>>> ListArchivesAsResponseAsync(
            string? before = default,
            string? after = default,
            int? limit = default,
            global::Letta.ListArchivesOrder? order = default,
