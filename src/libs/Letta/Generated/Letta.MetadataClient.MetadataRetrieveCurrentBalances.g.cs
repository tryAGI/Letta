...
namespace Letta
{
    public partial class MetadataClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_MetadataRetrieveCurrentBalancesSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_MetadataRetrieveCurrentBalancesSecurityRequirement0,
            };
        partial void PrepareMetadataRetrieveCurrentBalancesArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareMetadataRetrieveCurrentBalancesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessMetadataRetrieveCurrentBalancesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMetadataRetrieveCurrentBalancesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.MetadataRetrieveCurrentBalancesResponse> MetadataRetrieveCurrentBalancesAsync(
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await MetadataRetrieveCurrentBalancesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.MetadataRetrieveCurrentBalancesResponse>> MetadataRetrieveCurrentBalancesAsResponseAsync(
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMetadataRetrieveCurrentBalancesArguments(
                httpClient: HttpClient);


            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_MetadataRetrieveCurrentBalancesSecurityRequirements,
                operationName: "MetadataRetrieveCurrentBalancesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMetadataRetrieveCurrentBalancesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MetadataRetrieveCurrentBalances",
                                methodName: "MetadataRetrieveCurrentBalancesAsync",
                                pathTemplate: "\"/v1/metadata/balance\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMetadataRetrieveCurrentBalancesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMetadataRetrieveCurrentBalancesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.MetadataRetrieveCurrentBalancesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.MetadataRetrieveCurrentBalancesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.MetadataRetrieveCurrentBalancesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
