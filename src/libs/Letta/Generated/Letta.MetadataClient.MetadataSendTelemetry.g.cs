...
namespace Letta
{
    public partial class MetadataClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_MetadataSendTelemetrySecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_MetadataSendTelemetrySecurityRequirement0,
            };
        partial void PrepareMetadataSendTelemetryArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Letta.MetadataSendTelemetryRequest request);
        partial void PrepareMetadataSendTelemetryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Letta.MetadataSendTelemetryRequest request);
        partial void ProcessMetadataSendTelemetryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMetadataSendTelemetryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await MetadataSendTelemetryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.MetadataSendTelemetryResponse>> MetadataSendTelemetryAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareMetadataSendTelemetryArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_MetadataSendTelemetrySecurityRequirements,
                operationName: "MetadataSendTelemetryAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMetadataSendTelemetryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MetadataSendTelemetry",
                                methodName: "MetadataSendTelemetryAsync",
                                pathTemplate: "\"/v1/metadata/telemetry\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMetadataSendTelemetryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMetadataSendTelemetryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.MetadataSendTelemetryResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.MetadataSendTelemetryResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.MetadataSendTelemetryResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await MetadataSendTelemetryAsync(
                request: __request,
                requestOptions: requestOptions,
