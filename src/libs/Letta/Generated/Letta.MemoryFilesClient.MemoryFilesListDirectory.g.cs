            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_404 = global::Letta.MemoryFilesListDirectoryResponse2.FromJson(__content_404, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if ((int)__response.StatusCode == 501)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_501 = global::Letta.MemoryFilesListDirectoryResponse3.FromJson(__content_501, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_501 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Letta.MemoryFilesListDirectoryResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Letta.MemoryFilesListDirectoryResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
