...
namespace Letta
{
    public partial class SandboxesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_SandboxesListSandboxesSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_SandboxesListSandboxesSecurityRequirement0,
            };
        partial void PrepareSandboxesListSandboxesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? agentId,
            ref string? limit);
        partial void PrepareSandboxesListSandboxesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? agentId,
            string? limit);
        partial void ProcessSandboxesListSandboxesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSandboxesListSandboxesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.SandboxesListSandboxesResponse> SandboxesListSandboxesAsync(
            string? agentId = default,
            string? limit = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await SandboxesListSandboxesAsResponseAsync(
                agentId: agentId,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.SandboxesListSandboxesResponse>> SandboxesListSandboxesAsResponseAsync(
            string? agentId = default,
            string? limit = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareSandboxesListSandboxesArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SandboxesListSandboxesSecurityRequirements,
                operationName: "SandboxesListSandboxesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareSandboxesListSandboxesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SandboxesListSandboxes",
                                methodName: "SandboxesListSandboxesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessSandboxesListSandboxesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSandboxesListSandboxesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.SandboxesListSandboxesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.SandboxesListSandboxesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.SandboxesListSandboxesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
