...
namespace Letta
{
    public partial interface IStepsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Letta.Step>>> ListStepsAsResponseAsync(
            string? before = default,
            string? after = default,
            int? limit = default,
            global::Letta.ListStepsOrder? order = default,
