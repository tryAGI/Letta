...
{
    /// <inheritdoc />
    public class InputVariant2Item3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Letta.InputVariant2Item3>
    {
        /// <inheritdoc />
        public override global::Letta.InputVariant2Item3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Letta.LettaBatchRequestInputVariant2ItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Letta.LettaBatchRequestInputVariant2ItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Letta.LettaBatchRequestInputVariant2ItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Letta.TextContent? text = default;
            if (discriminator?.Type == global::Letta.LettaBatchRequestInputVariant2ItemDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::Letta.LettaBatchRequestInputVariant2ItemDiscriminatorType.Image)
            {
            ...
            if (discriminator?.Type == global::Letta.LettaBatchRequestInputVariant2ItemDiscriminatorType.ToolCall)
            {
            ...
            if (discriminator?.Type == global::Letta.LettaBatchRequestInputVariant2ItemDiscriminatorType.ToolReturn)
            {
            ...
            if (discriminator?.Type == global::Letta.LettaBatchRequestInputVariant2ItemDiscriminatorType.OmittedReasoning)
            {
            ...
            if (discriminator?.Type == global::Letta.LettaBatchRequestInputVariant2ItemDiscriminatorType.RedactedReasoning)
            {
            ...
            if (discriminator?.Type == global::Letta.LettaBatchRequestInputVariant2ItemDiscriminatorType.SummarizedReasoning)
            {
            ...
            var __value = new global::Letta.InputVariant2Item3(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::Letta.InputVariant2Item3 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
