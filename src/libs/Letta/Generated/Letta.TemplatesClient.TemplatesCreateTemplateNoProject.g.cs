...
namespace Letta
{
    public partial class TemplatesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_TemplatesCreateTemplateNoProjectSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
        ...
        partial void PrepareTemplatesCreateTemplateNoProjectArguments(
            ...
            global::Letta.TemplatesCreateTemplateNoProjectRequest request);
        ...
        {
            var __response = await TemplatesCreateTemplateNoProjectAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.TemplatesCreateTemplateNoProjectResponse>> TemplatesCreateTemplateNoProjectAsResponseAsync(
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Letta.TemplatesCreateTemplateNoProjectResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Letta.TemplatesCreateTemplateNoProjectResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.TemplatesCreateTemplateNoProjectResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.TemplatesCreateTemplateNoProjectResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.TemplatesCreateTemplateNoProjectResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.TemplatesCreateTemplateNoProjectResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
