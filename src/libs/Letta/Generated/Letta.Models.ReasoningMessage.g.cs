...
namespace Letta
{
    ...
    public sealed partial class ReasoningMessage
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Letta.JsonConverters.ReasoningMessageSourceJsonConverter))]
        public global::Letta.ReasoningMessageSource? Source { get; set; }
        ...
        public ReasoningMessage(
            ...
            int? seqId,
            string? runId,
            global::Letta.ReasoningMessageSource? source,
            string? signature)
        {
