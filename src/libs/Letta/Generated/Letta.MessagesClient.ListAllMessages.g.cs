...
namespace Letta
{
    public partial class MessagesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_ListAllMessagesSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
        ...
        partial void ProcessListAllMessagesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ListAllMessagesAsResponseAsync(
                before: before,
                after: after,
                limit: limit,
                order: order,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Letta.LettaMessageUnion>>> ListAllMessagesAsResponseAsync(
            string? before = default,
            string? after = default,
            int? limit = default,
            global::Letta.ListAllMessagesOrder? order = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAllMessagesArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListAllMessagesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAllMessagesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAllMessagesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
