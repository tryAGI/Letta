...
namespace Letta
{
    public partial class BlocksClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_DetachIdentityFromBlockSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_DetachIdentityFromBlockSecurityRequirement0,
            };
        partial void PrepareDetachIdentityFromBlockArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string identityId,
            ref string blockId);
        partial void PrepareDetachIdentityFromBlockRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string identityId,
            string blockId);
        partial void ProcessDetachIdentityFromBlockResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDetachIdentityFromBlockResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.BlockResponse> DetachIdentityFromBlockAsync(
            string identityId,
            string blockId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DetachIdentityFromBlockAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.BlockResponse>> DetachIdentityFromBlockAsResponseAsync(
            string identityId,
            string blockId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDetachIdentityFromBlockArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DetachIdentityFromBlockSecurityRequirements,
                operationName: "DetachIdentityFromBlockAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDetachIdentityFromBlockRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DetachIdentityFromBlock",
                                methodName: "DetachIdentityFromBlockAsync",
                                pathTemplate: "$\"/v1/blocks/{blockId}/identities/detach/{identityId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDetachIdentityFromBlockResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDetachIdentityFromBlockResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.BlockResponse>(
                                        statusCode: __response.StatusCode,
