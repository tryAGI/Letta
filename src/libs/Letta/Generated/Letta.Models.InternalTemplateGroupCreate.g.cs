...
namespace Letta
{
    ...
    public sealed partial class InternalTemplateGroupCreate
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Letta.JsonConverters.ManagerConfig3JsonConverter))]
        public global::Letta.ManagerConfig3? ManagerConfig { get; set; }
        ...
        public InternalTemplateGroupCreate(
            ...
            string templateId,
            string deploymentId,
            global::Letta.ManagerConfig3? managerConfig,
            string? projectId,
            bool? hidden)
        {
