...
namespace Letta
{
    ...
    public sealed partial class GroupCreate
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Letta.JsonConverters.ManagerConfigJsonConverter))]
        public global::Letta.ManagerConfig? ManagerConfig { get; set; }
        ...
        public GroupCreate(
            ...
            string description,
            global::Letta.ManagerConfig? managerConfig,
            string? projectId,
            bool? hidden)
        {
