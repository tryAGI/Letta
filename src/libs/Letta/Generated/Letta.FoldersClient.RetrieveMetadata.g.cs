                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Letta.OrganizationSourcesStats.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Letta.OrganizationSourcesStats.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
