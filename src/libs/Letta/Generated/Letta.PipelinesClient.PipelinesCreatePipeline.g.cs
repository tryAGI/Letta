...
namespace Letta
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_PipelinesCreatePipelineSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_PipelinesCreatePipelineSecurityRequirement0,
            };
        partial void PreparePipelinesCreatePipelineArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Letta.PipelinesCreatePipelineRequest request);
        partial void PreparePipelinesCreatePipelineRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Letta.PipelinesCreatePipelineRequest request);
        partial void ProcessPipelinesCreatePipelineResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelinesCreatePipelineResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.PipelinesCreatePipelineResponse> PipelinesCreatePipelineAsync(

            global::Letta.PipelinesCreatePipelineRequest request,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PipelinesCreatePipelineAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesCreatePipelineResponse>> PipelinesCreatePipelineAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePipelinesCreatePipelineArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinesCreatePipelineSecurityRequirements,
                operationName: "PipelinesCreatePipelineAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePipelinesCreatePipelineRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinesCreatePipeline",
                                methodName: "PipelinesCreatePipelineAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelinesCreatePipelineResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Letta.PipelinesCreatePipelineResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Letta.PipelinesCreatePipelineResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.PipelinesCreatePipelineResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelinesCreatePipelineResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.PipelinesCreatePipelineResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesCreatePipelineResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.PipelinesCreatePipelineResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.PipelinesCreatePipelineResponse> PipelinesCreatePipelineAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Letta.PipelinesCreatePipelineRequest
            {
                Name = name,
                ProjectId = projectId,
                IntegrationType = integrationType,
                ProducerConfig = producerConfig,
                SubscriberAgentIds = subscriberAgentIds,
                SubscriberCronSchedule = subscriberCronSchedule,
                PromptTemplate = promptTemplate,
            };

            return await PipelinesCreatePipelineAsync(
                request: __request,
                requestOptions: requestOptions,
