...
namespace Letta
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_PipelinesUpdatePipelineSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_PipelinesUpdatePipelineSecurityRequirement0,
            };
        partial void PreparePipelinesUpdatePipelineArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId,
            global::Letta.PipelinesUpdatePipelineRequest request);
        partial void PreparePipelinesUpdatePipelineRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId,
            global::Letta.PipelinesUpdatePipelineRequest request);
        partial void ProcessPipelinesUpdatePipelineResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPipelinesUpdatePipelineResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.PipelinesUpdatePipelineResponse> PipelinesUpdatePipelineAsync(
            string pipelineId,
        ...
        {
            var __response = await PipelinesUpdatePipelineAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesUpdatePipelineResponse>> PipelinesUpdatePipelineAsResponseAsync(
            string pipelineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePipelinesUpdatePipelineArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PipelinesUpdatePipelineSecurityRequirements,
                operationName: "PipelinesUpdatePipelineAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinesUpdatePipeline",
                                methodName: "PipelinesUpdatePipelineAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPipelinesUpdatePipelineResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Letta.PipelinesUpdatePipelineResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Letta.PipelinesUpdatePipelineResponse2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.PipelinesUpdatePipelineResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPipelinesUpdatePipelineResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.PipelinesUpdatePipelineResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.PipelinesUpdatePipelineResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.PipelinesUpdatePipelineResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PipelinesUpdatePipelineAsync(
                pipelineId: pipelineId,
                request: __request,
                requestOptions: requestOptions,
