...
namespace Letta
{
    public partial class StepsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_ModifyFeedbackForStepSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_ModifyFeedbackForStepSecurityRequirement0,
            };
        partial void PrepareModifyFeedbackForStepArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string stepId,
            global::Letta.ModifyFeedbackRequest request);
        partial void PrepareModifyFeedbackForStepRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string stepId,
            global::Letta.ModifyFeedbackRequest request);
        partial void ProcessModifyFeedbackForStepResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessModifyFeedbackForStepResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.Step> ModifyFeedbackForStepAsync(
            string stepId,
        ...
        {
            var __response = await ModifyFeedbackForStepAsResponseAsync(
                stepId: stepId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.Step>> ModifyFeedbackForStepAsResponseAsync(
            string stepId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareModifyFeedbackForStepArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModifyFeedbackForStepSecurityRequirements,
                operationName: "ModifyFeedbackForStepAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModifyFeedbackForStep",
                                methodName: "ModifyFeedbackForStepAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessModifyFeedbackForStepResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModifyFeedbackForStepResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.Step.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.Step>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.Step.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.Step> ModifyFeedbackForStepAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Letta.ModifyFeedbackRequest
            {
                Feedback = feedback,
                Tags = tags,
            };

            return await ModifyFeedbackForStepAsync(
                stepId: stepId,
                request: __request,
                requestOptions: requestOptions,
