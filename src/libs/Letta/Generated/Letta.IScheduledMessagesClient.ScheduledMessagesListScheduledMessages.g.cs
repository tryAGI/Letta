...
namespace Letta
{
    public partial interface IScheduledMessagesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.ScheduledMessagesListScheduledMessagesResponse>> ScheduledMessagesListScheduledMessagesAsResponseAsync(
            string agentId,
            string? limit = default,
            string? after = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
