...
namespace Letta
{
    public partial interface IClientSideAccessTokensClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.ClientSideAccessTokensListClientSideAccessTokensResponse>> ClientSideAccessTokensListClientSideAccessTokensAsResponseAsync(
            string? agentId = default,
            double? offset = default,
            double? limit = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
