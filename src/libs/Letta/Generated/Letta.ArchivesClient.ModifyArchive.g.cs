...
namespace Letta
{
    public partial class ArchivesClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_ModifyArchiveSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_ModifyArchiveSecurityRequirement0,
            };
        partial void PrepareModifyArchiveArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string archiveId,
            global::Letta.ArchiveUpdateRequest request);
        partial void PrepareModifyArchiveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string archiveId,
            global::Letta.ArchiveUpdateRequest request);
        partial void ProcessModifyArchiveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessModifyArchiveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.Archive> ModifyArchiveAsync(
            string archiveId,
        ...
        {
            var __response = await ModifyArchiveAsResponseAsync(
                archiveId: archiveId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.Archive>> ModifyArchiveAsResponseAsync(
            string archiveId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModifyArchiveSecurityRequirements,
                operationName: "ModifyArchiveAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModifyArchive",
                                methodName: "ModifyArchiveAsync",
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModifyArchiveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.Archive.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.Archive>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.Archive.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ModifyArchiveAsync(
                archiveId: archiveId,
                request: __request,
                requestOptions: requestOptions,
