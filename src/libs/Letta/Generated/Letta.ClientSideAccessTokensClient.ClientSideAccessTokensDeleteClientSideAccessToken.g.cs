...
namespace Letta
{
    public partial class ClientSideAccessTokensClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_ClientSideAccessTokensDeleteClientSideAccessTokenSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<string>> ClientSideAccessTokensDeleteClientSideAccessTokenAsResponseAsync(
            string token,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Letta.ClientSideAccessTokensDeleteClientSideAccessTokenResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Letta.ClientSideAccessTokensDeleteClientSideAccessTokenResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.ClientSideAccessTokensDeleteClientSideAccessTokenResponse2>.Create(
