...
namespace Letta
{
    public partial class ModelsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_ListEmbeddingModelsSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_ListEmbeddingModelsSecurityRequirement0,
            };
        partial void PrepareListEmbeddingModelsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareListEmbeddingModelsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessListEmbeddingModelsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListEmbeddingModelsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::Letta.EmbeddingModel>> ListEmbeddingModelsAsync(
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ListEmbeddingModelsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Letta.EmbeddingModel>>> ListEmbeddingModelsAsResponseAsync(
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListEmbeddingModelsArguments(
                httpClient: HttpClient);


            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_ListEmbeddingModelsSecurityRequirements,
                operationName: "ListEmbeddingModelsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListEmbeddingModelsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListEmbeddingModelsAsync",
                                pathTemplate: "\"/v1/models/embedding\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListEmbeddingModelsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListEmbeddingModelsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Letta.EmbeddingModel>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Letta.EmbeddingModel>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Letta.EmbeddingModel>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Letta.EmbeddingModel>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Letta.EmbeddingModel>), JsonSerializerContext).ConfigureAwait(false) ??
