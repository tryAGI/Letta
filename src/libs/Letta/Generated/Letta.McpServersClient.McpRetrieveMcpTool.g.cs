...
namespace Letta
{
    public partial class McpServersClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_McpRetrieveMcpToolSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_McpRetrieveMcpToolSecurityRequirement0,
            };
        partial void PrepareMcpRetrieveMcpToolArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string mcpServerId,
            ref string toolId);
        partial void PrepareMcpRetrieveMcpToolRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string mcpServerId,
            string toolId);
        partial void ProcessMcpRetrieveMcpToolResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMcpRetrieveMcpToolResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.Tool> McpRetrieveMcpToolAsync(
            string mcpServerId,
            string toolId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await McpRetrieveMcpToolAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.Tool>> McpRetrieveMcpToolAsResponseAsync(
            string mcpServerId,
            string toolId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareMcpRetrieveMcpToolArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_McpRetrieveMcpToolSecurityRequirements,
                operationName: "McpRetrieveMcpToolAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareMcpRetrieveMcpToolRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "McpRetrieveMcpTool",
                                methodName: "McpRetrieveMcpToolAsync",
                                pathTemplate: "$\"/v1/mcp-servers/{mcpServerId}/tools/{toolId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessMcpRetrieveMcpToolResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessMcpRetrieveMcpToolResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.Tool.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.Tool>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.Tool.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
