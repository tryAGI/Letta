...
namespace Letta
{
    public partial class BlocksClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_CountBlocksSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_CountBlocksSecurityRequirement0,
            };
        partial void PrepareCountBlocksArguments(
        ...
        partial void PrepareCountBlocksRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? matchAllTags,
            string? projectId);
        partial void ProcessCountBlocksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCountBlocksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<int> CountBlocksAsync(
        ...
        {
            var __response = await CountBlocksAsResponseAsync(
                label: label,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<int>> CountBlocksAsResponseAsync(
            string? label = default,
            bool? templatesOnly = default,
            string? name = default,
            global::System.Collections.Generic.IList<string>? tags = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CountBlocksSecurityRequirements,
                operationName: "CountBlocksAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CountBlocks",
                                methodName: "CountBlocksAsync",
                                pathTemplate: "\"/v1/blocks/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCountBlocksResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
