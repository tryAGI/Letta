...
namespace Letta
{
    public partial class StepsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_RetrieveMetricsForStepSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_RetrieveMetricsForStepSecurityRequirement0,
            };
        partial void PrepareRetrieveMetricsForStepArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string stepId);
        partial void PrepareRetrieveMetricsForStepRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string stepId);
        partial void ProcessRetrieveMetricsForStepResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetrieveMetricsForStepResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.StepMetrics> RetrieveMetricsForStepAsync(
            string stepId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await RetrieveMetricsForStepAsResponseAsync(
                stepId: stepId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.StepMetrics>> RetrieveMetricsForStepAsResponseAsync(
            string stepId,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveMetricsForStepArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RetrieveMetricsForStepSecurityRequirements,
                operationName: "RetrieveMetricsForStepAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetrieveMetricsForStep",
                                methodName: "RetrieveMetricsForStepAsync",
                                pathTemplate: "$\"/v1/steps/{stepId}/metrics\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRetrieveMetricsForStepResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRetrieveMetricsForStepResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.StepMetrics.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.StepMetrics>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.StepMetrics.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
