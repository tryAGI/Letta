...
namespace Letta
{
    public partial class FeedsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_FeedsSubscribeAgentSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_FeedsSubscribeAgentSecurityRequirement0,
            };
        partial void PrepareFeedsSubscribeAgentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string feedId,
            global::Letta.FeedsSubscribeAgentRequest request);
        partial void PrepareFeedsSubscribeAgentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string feedId,
            global::Letta.FeedsSubscribeAgentRequest request);
        partial void ProcessFeedsSubscribeAgentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFeedsSubscribeAgentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.FeedsSubscribeAgentResponse> FeedsSubscribeAgentAsync(
            string feedId,
        ...
        {
            var __response = await FeedsSubscribeAgentAsResponseAsync(
                feedId: feedId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.FeedsSubscribeAgentResponse>> FeedsSubscribeAgentAsResponseAsync(
            string feedId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareFeedsSubscribeAgentArguments(
            ...
            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FeedsSubscribeAgentSecurityRequirements,
                operationName: "FeedsSubscribeAgentAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FeedsSubscribeAgent",
                                methodName: "FeedsSubscribeAgentAsync",
                                pathTemplate: "$\"/v1/feeds/{feedId}/subscribe\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFeedsSubscribeAgentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::Letta.FeedsSubscribeAgentResponse2? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::Letta.FeedsSubscribeAgentResponse2.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.FeedsSubscribeAgentResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessFeedsSubscribeAgentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.FeedsSubscribeAgentResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.FeedsSubscribeAgentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.FeedsSubscribeAgentResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await FeedsSubscribeAgentAsync(
                feedId: feedId,
                request: __request,
                requestOptions: requestOptions,
