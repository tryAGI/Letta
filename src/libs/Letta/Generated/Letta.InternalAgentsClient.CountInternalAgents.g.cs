...
namespace Letta
{
    public partial class InternalAgentsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_CountInternalAgentsSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
            {                s_CountInternalAgentsSecurityRequirement0,
            };
        partial void PrepareCountInternalAgentsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? excludeHidden);
        partial void PrepareCountInternalAgentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? excludeHidden);
        partial void ProcessCountInternalAgentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCountInternalAgentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<int> CountInternalAgentsAsync(
            bool? excludeHidden = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CountInternalAgentsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<int>> CountInternalAgentsAsResponseAsync(
            bool? excludeHidden = default,
            global::Letta.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCountInternalAgentsArguments(
                httpClient: HttpClient,
                excludeHidden: ref excludeHidden);


            var __authorizations = global::Letta.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CountInternalAgentsSecurityRequirements,
                operationName: "CountInternalAgentsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCountInternalAgentsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Letta.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Letta.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CountInternalAgents",
                                methodName: "CountInternalAgentsAsync",
                                pathTemplate: "\"/v1/_internal_agents/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCountInternalAgentsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCountInternalAgentsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Letta.AutoSDKHttpResponse<int>(
                                        statusCode: __response.StatusCode,
