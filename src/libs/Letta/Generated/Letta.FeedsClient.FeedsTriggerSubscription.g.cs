...
namespace Letta
{
    public partial class FeedsClient
    {
        ...
        private static readonly global::Letta.EndPointSecurityRequirement[] s_FeedsTriggerSubscriptionSecurityRequirements =
            new global::Letta.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Letta.FeedsTriggerSubscriptionResponse> FeedsTriggerSubscriptionAsync(
            string feedId,
            string subscriptionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Letta.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Letta.AutoSDKHttpResponse<global::Letta.FeedsTriggerSubscriptionResponse>> FeedsTriggerSubscriptionAsResponseAsync(
            string feedId,
            string subscriptionId,
                ...
                else
                {
                    await global::Letta.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Letta.FeedsTriggerSubscriptionResponse2? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Letta.FeedsTriggerSubscriptionResponse2.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Letta.ApiException<global::Letta.FeedsTriggerSubscriptionResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Letta.FeedsTriggerSubscriptionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Letta.AutoSDKHttpResponse<global::Letta.FeedsTriggerSubscriptionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Letta.FeedsTriggerSubscriptionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
